...
namespace FinOrg
{
    ...
    public partial class FrmEmployees : Form
    {
        ...
        public FrmEmployees()
        {
            ...
            ClearTextBoxes(this);
            isini = true;
            txttrn_type.Text = Gvar._Gind.ToString();
            Load_data();
            Load_grid();
            ...
            try
            {
               ...
               // foreach (Control tx in this.Controls)
                ...
                if (isedit == false)
                {
                    ...
                    sql = sql + " VALUES ('" + Txtitem.Text.Trim() + "','" + txtname.Text.Trim() + "','" + txtname.Text + "','" + Gvar._Userid + "','" + cmbcat.SelectedValue + "','" + cmbunit.SelectedValue + "','" + txtfraction.Text + "','" + txtarabic + "'," + Gvar.brn_code + ",'" + txtbarcode + "')";
                    ...
                    sql = " INSERT INTO [STOCK_MASTER]([Item_Code],[STOCK],[LAST_PUR_PRICE],[AVG_PUR_PRICE],[USER1],[RE_ORDER],[BRN_CODE],[OP_STOCK],sale_price,retail_price,profit,expense_amt,net_cost,SALES_PROFIT_PCNT)";
                        sql = sql + " VALUES ('" + Txtitem.Text.Trim() + "','" + txtclstock.Text + "','" + lst_price + "','" + avg_price + "','" + Gvar._Userid + "','" + txtorder + "'," + Gvar.brn_code + ",'" + txtopstock.Text + "','" + txtsaleprice + "','" + txtretailprice +"','" + txtminprofit.Text +"','" + txtlastexp.Text +"','" + net_cost +"','" + txtsaleprofit.Text +"' )"; 
                ...
                else
                {
                   ...
                   // object txtarabic = row.Cells["colvalue"].Value;
                    ...
                    sql = "update  [HD_ITEMMASTER]  set [Item_Code]='" + Txtitem.Text.Trim() + "',[DESCRIPTION]='" + txtname.Text + "',[ar_desc]='" + txtarabic + "',[ITM_CAT_CODE]='" + cmbcat.SelectedValue + "',[UNIT]='" + cmbunit.SelectedValue + "',[FRACTION]='" + txtfraction.Text + "',[ALIAS_NAME]='" + txtalias + "',BARCODE ='" + txtbarcode + "'  where Item_Code ='" + txtolditm.Text + "'";
                ...
                if (!rd.HasRows)
                {
                    ...
                    sql = sql + " VALUES ('" + Txtitem.Text.Trim() + "','" + txtclstock.Text + "','" + lst_price + "','" + avg_price + "','" + Gvar._Userid + "','" + txtorder + "',1,'" + txtopstock.Text + "','" + txtsaleprice + "','" + txtretailprice + "')";
                ...
                for (int i = 0; i <= grdbarcode.Rows.Count-1; i++)
                {
                    if (grdbarcode["barcode", i].Value != null && grdbarcode["barcode", i].Value != "")
                    {
                        ...
                        bcode.Fields["brn_code"].Value = Gvar.brn_code;
        ...
        private void btnaddsup_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                sql = sql + " FROM ACCOUNTS left join accouns_info on accounts.acc_no=account_info.acc_no WHERE accounts.ACC_NO  =" + CMBSUP.SelectedValue;
...

        {
                        ...
                        try
                        {
                            ...
                            foreach (DataGridViewRow row in this.grdstock.Rows)
                            {
                                    ...
                                    //if (!string.IsNullOrEmpty(row.Cells[0].Value.ToString()) && !string.IsNullOrEmpty(row.Cells[2].Value.ToString()))
                                {
                                    ...
                                    sql = "SELECT * FROM TRN_MASTER WHERE BRN_CODE = "+ Gvar.brn_code  + " AND INV_NO ='" + v1 + "' and  WR_CODE =" + v1 ;
                                    ...
                                    cus.Fields["INV_NO"].Value = v1;

                                    cus.Fields["cus_code"].Value = 5016;
                                    cus.Fields["cus_name"].Value = "OPENING BALANCE";
                                    cus.Fields["trn_type"].Value = 0;
                                    cus.Fields["TOT_AMOUNT"].Value = Convert.ToDouble(v2) * Convert.ToDouble(txtcost.Text);
                                    ...
                                    sql = " SELECT * FROM TRN_ITM_DETAIL1 WHERE  BRN_CODE = " + Gvar.brn_code + " AND  WR_CODE ='" + v1 + "' AND TRN_TYPE = 0 AND Item_Code ='" + Txtitem.Text.Trim() + "'";
               ...
               // SAVE TO DATA_GRID
                                    ...
                                    sql = "SELECT * FROM DATA_ENTRY WHERE  BRN_CODE = " + Gvar.brn_code + " AND INVOICE_NO = '" + v1 + "' and wr_code ='" + v1 + "' AND TRN_TYPE=0";
                                    ...
                                    rec.Fields["INVOICE_NO"].Value = v1;
                                   ...
                                   // rec.Fields["COST_CODE"].Value = 0;
                                    ...
                                    rec.Fields["G_TOTAL"].Value = Convert.ToDouble(v2) * Convert.ToDouble(txtcost.Text); ;
                                    rec.Fields["NET_AMOUNT"].Value = Convert.ToDouble(v2) * Convert.ToDouble(txtcost.Text); ;
                                    rec.Fields["remarks"].Value ="";

                                    rec.Update();

                                    sql = "SELECT rec_no FROM DATA_ENTRY WHERE  BRN_CODE = " + Gvar.brn_code + " AND  INVOICE_NO = '" + v1 + "' and  wr_code ='" + v1 + "' AND TRN_TYPE=0";
                                    ...
                                    sql = "SELECT * FROM DATA_ENTRY_GRID WHERE  BRN_CODE = " + Gvar.brn_code + " AND  wr_code ='" + v1 + "' and Item_Code = '" + Txtitem.Text.Trim() + "' and trn_type =0";
                                        ...
                                        if (rd.HasRows)
                                        {
                                            while (rd.Read())
                                            {
                                                if (!string.IsNullOrEmpty(rd[0].ToString()))
                                                {
                                                    ...
                                                    trn_no = Convert.ToDouble( rd[0]);
                                                    sql = "Update STOCK_MASTER set stock =" + trn_no + " where    Item_Code='" + Txtitem.Text.Trim() + "' AND BRN_CODE=" + Gvar.brn_code;
        ...
        private void search_data(string Item_Code)
        {
            try
            {
                ...
                sql = "sELECT  h.Item_Code,h.DESCRIPTION,h.ITM_CAT_CODE,h.UNIT,h.FRACTION,h.ALIAS_NAME,s.AVG_PUR_PRICE,s.RE_ORDER,S.AVG_PUR_PRICE,H.BARCODE,H.AR_DESC,SALE_PRICE,RETAIL_PRICE,PART_NO,BRAND,SUB_CAT_CODE from hd_ITEMMASTER h left join stock_master s on h.Item_Code=s.Item_Code where h.brn_code=" + Gvar.brn_code + "  and h.Item_Code='" + Item_Code + "'";
                SqlCommand cmd = new SqlCommand(sql, Conn);
                //SqlDataReader rd = cmd.ExecuteReader();
              ...
              try
              {
                  try
                  {
                      ...
                      if (Convert.ToDecimal(TXTSRAMT) > 0)
                      {
                          ...
                          sql = "DELETE FROM TRN_ACCOUNTS WHERE NYEAR='" + Gvar.nyear + "' and TRN_by=" + TRNBY + " and DOC_NO='" + docno + "'  and BRN_CODE =" + Gvar.brn_code;
                          TMP = new Recordset();
                          TMP.Open(sql, ADOconn, ADODB.CursorTypeEnum.adOpenStatic, ADODB.LockTypeEnum.adLockOptimistic, -1);
                          ...
                          sql = "DELETE FROM TRN_PAYMENT_DET WHERE NYEAR=" + Gvar.nyear + " and TRN_by=" + TRNBY + " and DOC_NO='" + docno + "'  and BRN_CODE =" + Gvar.brn_code;
