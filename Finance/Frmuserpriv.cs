    ...
    public partial class Frmuserpriv : Form
    {
        ...
        private void load_form()
        {
            ...
            try
            {
                ...
                dgv1.Columns[0].Name = "MenuName";
                dgv1.Columns[1].Name = "ins";

                dgv1.Columns[2].Name = "upd";
                dgv1.Columns[3].Name = "del";

                dgv1.Columns[4].Name = "dsp";
                dgv1.Columns[5].Name = "id";
                dgv1.Columns[6].Name = "Menu_Name";
                dgv1.Columns[7].Name = "Head";
                dgv1.Columns[8].Name = "group_name";
                ...
                dgv1.Columns[0].Width = 380;
                dgv1.Columns[0].HeaderCell.Style.Alignment = 0;
