    ...
    public partial class frmAccTran : Form
    {
        ...
        private void load_form()
        {
            ...
            try
            {
                ...
                if (Gvar.trntype == 200)
                {
                    dgv1.Columns[0].HeaderText = "Paid To";
                    dgv1.Columns[6].HeaderText = "Paid From";
                    ...
                    case Keys.Enter:
                        ...
                        if (GrdLookup.Visible)
                        {
                            ...
                            if (last_col == "accno2")
                            {
                                ...
                                //this.dgv1.CurrentCell = this.dgv1["accno2", dblclk_row];
                                GrdLookup.Visible = false;
                                dgv1.Focus();
            ...
            try
            {
                ...
                switch (GrdLookup.Tag.ToString())
                {
                    ...
                    case "accno2":
                        ...
                        dgv1.CurrentCell = dgv1["accno2", dblclk_row];
        ...
        private void dgv1_CellLeave(object sender, DataGridViewCellEventArgs e)
        {
            try
            {
                ...
                if (!GrdLookup.Visible)
                {
                    ...
                    if ((dgv1.Columns[e.ColumnIndex].Name == "accno1" || dgv1.Columns[e.ColumnIndex].Name == "accno2") & dgv1[e.ColumnIndex, e.RowIndex].Value != null)
                    {
        ...
        private void dgv1_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (dgv1.CurrentCell == dgv1["accno1", cur_row] || dgv1.CurrentCell == dgv1["accno2", cur_row])
            ...
            try
            {
                ...
                for (i = 0; i < dgv1.RowCount; i++)
                {
                    ...
                    if (celval.Trim() != "")
                    {
                        ...
                        if (dgv1["accno2", i].Value == "" || dgv1["accno2", i].Value == null)
                        {
                            dgv1.CurrentCell = dgv1["accno2", i];
                            MessageBox.Show("Invalid Entry on Row " + ++i);
                            return;
                        }
                        ...
                        if (dgv1["accno1", i].Value == null || dgv1["accno2", i].Value == null || dgv1["accno2", i].Value == "")
                            if (dgv1["accamt", i].Value == null || dgv1["accno2", i].Value == null || dgv1["Accname1", i].Value == null || dgv1["accname2", i].Value == null)
                            {
                                MessageBox.Show("Invalid Entry on Row " + ++i);
                                dgv1.CurrentCell = dgv1["accno1", i];
                                return;
                ...
                rec.Fields["AMOUNT"].Value = Convert.ToDouble(txttotal.Text) * Convert.ToDouble(txtrate.Text);
                rec.Fields["CURRENCY_CODE"].Value =cmbcurrency.SelectedValue;
                rec.Fields["CURRENCY_RATE"].Value = txtrate.Text;
                rec.Fields["FAMOUNT"].Value = Convert.ToDouble(txttotal.Text);
                rec.Update();
                ...
                for (i = 0; i < dgv1.RowCount; i++)
                {
                    ...
                    if (celval.Trim() != "")
                    {
                        ...
                        if (dgv1["trnno2", i].Value == null || dgv1["trnno2", i].Value == "") dgv1["trnno2", i].Value = 0;
                        ...
                        trnno2 = Convert.ToInt32(dgv1["trnno2", i].Value);
                       ...
                       ADOconn.Execute (sql,out a,-1);
                        ...
                        rec.Fields["DR_CR"].Value = DR_CR;
                        rec.Fields["user_ID"].Value = Gvar.Userid;
                        rec.Fields["PAYBY"].Value = dgv1["ACCNO2", i].Value;
                        //rec.Fields["RQTY"].Value = 0;
                        rec.Fields["SNO"].Value = i;
                        // rec.Fields["FRACTION"].Value = dgv1["fraction", i].Value;
                        rec.Fields["NARRATION"].Value = Nar2 + dgv1["accname2", i].Value + " " + dgv1["NARRATION", i].Value;
                       ...
                       // rec.Fields["CostCode"].Value = dgv1["CostCode", i].Value;
                        ...
                        if (dgv1["trnno2", i].Value == null) dgv1["trnno2", i].Value = 0;
                        sql = "select * from TRN_accounts where  trn_no = " + Convert.ToInt32(dgv1["trnno2", i].Value);
                        ...
                        rec1.Fields["acc_no"].Value = dgv1["ACCNO2", i].Value;
                        rec1.Fields["EntrY_no"].Value = txttrn.Text.Trim();
                        rec1.Fields["trn_no"].Value = trnno2;
                        rec1.Fields["trn_no2"].Value = trnno;
                        rec1.Fields["PAY_AMOUNT"].Value = Convert.ToDecimal(dgv1["accamt", i].Value) * Convert.ToDecimal(txtrate.Text); ;
                        
                         frate = Gvar.Get_Currency_rate(Convert.ToDouble(dgv1["ACCNO2", i].Value), cmbcurrency.SelectedValue.ToString());
                        rec1.Fields["f_pay_amount"].Value = Convert.ToDouble(dgv1["accamt", i].Value) * Convert.ToDouble(txtrate.Text) / frate;
                        rec1.Fields["F_RATE"].Value = frate;
                        ...
                        rec1.Fields["PAYBY"].Value = dgv1["ACCNO1", i].Value;
                        //rec.Fields["RQTY"].Value = 0;
                        rec1.Fields["SNO"].Value = i;
                        rec1.Fields["cost_code"].Value = dgv1["CostCode", i].Value;
                        rec1.Fields["dept_code"].Value = dgv1["DeptCode", i].Value;
                        // rec.Fields["FRACTION"].Value = dgv1["fraction", i].Value;
                        rec1.Fields["NARRATION"].Value = Nar1 + dgv1["accname1", i].Value + " " + dgv1["NARRATION", i].Value;
